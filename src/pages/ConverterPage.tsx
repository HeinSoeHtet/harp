    ...
    return (
        <div className="h-full flex flex-col max-w-7xl mx-auto relative">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
                {/* Info Card */}
                <div className="bg-white/5 rounded-3xl p-6 border border-white/10 flex flex-col gap-6">
                ...
                <div className={`
                    bg-white/10 backdrop-blur-md rounded-3xl p-6 border-2 border-dashed transition-all duration-300
